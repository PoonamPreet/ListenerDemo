...
public class MyListener implements HttpSessionListener, HttpSessionAttributeListener {
    ...
    public void attributeRemoved(HttpSessionBindingEvent arg0)  { 
    	System.out.println("From listener key with  "+arg0.getName()+"and value is "+arg0.getValue()+" removed succesfully");
    }
    ...
    public void attributeReplaced(HttpSessionBindingEvent arg0)  { 
    	System.out.println("From listener key with "+arg0.getName()+"and value is "+arg0.getValue()+" modified succesfully");
    }
